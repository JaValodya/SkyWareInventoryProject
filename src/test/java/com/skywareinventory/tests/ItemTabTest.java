...
public class ItemTabTest {
	...
	@Test(priority = 1)
	public void itemTabTest() throws InterruptedException, IOException {
		...
		driver.findElement(By.xpath("(//*[@id='thirdtabLink'])[2]")).click();
		Assert.assertTrue(driver.findElement(By.xpath("//*[@id='pageTitle']")).isDisplayed());
		driver.findElement(By.xpath("//*[@id='searchTerm']")).sendKeys("Cybertek",Keys.ENTER);
		Assert.assertTrue(driver.findElement(By.xpath("//*[@id='emptyRow']/td")).isDisplayed());
